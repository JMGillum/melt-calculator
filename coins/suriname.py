...
values = {
        "suriname_gulden_1": NamedList("1",["suriname_gulden_1_1"]),
}

# Stores NamedLists of keys from values
denominations = {
        "suriname_gulden": NamedList(AN("Gulden",["Guldens"]),["suriname_gulden_1"]),
}

# Stores every key inside of coins, with values of 
# tuples of (<value_id>,<denomination_id>,<country_id>)
coins_reverse_build = {
    "suriname_gulden_1_1": ("suriname_gulden_1","suriname_gulden","suriname"),
}
