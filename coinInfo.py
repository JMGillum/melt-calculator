...
class Coins:
    coins = {
        ...
        # Mexico
        "peso_1": Node(CoinData(
            years=[x for x in list(range(1920,1946)) if x not in list(range(1928,1932))+[1936,1937,1939,1941,1942]],
            weight=16.66,
            fineness=0.72,
            metal=Metals.SILVER,
            country="Mexico",
        ...
        "standing_liberty_quarter": Node(CoinData(
        ...
        "washington_quarter": Node(CoinData(
        ...
        "walking_liberty_half": Node(CoinData(
    ...
    values = {
        ...
        "quarter": NamedList("Quarters",["barber_quarter","standing_liberty_quarter","washington_quarter"]),
        "half": NamedList("Halves",["walking_liberty_half","benjamin_half","kennedy_half_1","kennedy_half_2"]),
