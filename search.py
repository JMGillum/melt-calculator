...
def Search(args:dict, db, purchases:dict, prices:dict, config:dict):
    ...
    if arguments_list:
        ...
        for arguments in arguments_list:
            ...
            if (
                ...
                # Converts the face value to a float
                ...
                if (not fail_year and not fail_face_value):
                    ...
                    # Search found some results
                        ...
                        # If tree is to be printed, print it
                        if not args["no_tree"]:
