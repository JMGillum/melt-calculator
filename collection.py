...
class Value:
    ...
    def __init__(self,coins:CoinData|list[CoinData]|None=None,face_value:int|float|None=None,name:str|None=None):
        self.name = ""
        if name is not None:
            self.name = name
...
class Denomination:
    ...
    def __init__(self,values:Value|list[Value]|None=None,name:str|None=None):
        self.name = ""
        if self.name is not None:
            self.name = name
...
class Country:
    def __init__(self,denominations:Denomination|list[Denomination]|None=None,name:str|None=None):
        self.name = ""
        if name is not None:
            self.name = name
...
class CoinCollection:
    def __init__(self,countries:Country|list[Country]|None=None,name:str|None=None):
        self.name = ""
        if name is not None:
            self.name = name
